...
class _CartScreenState extends State<CartScreen> {
  // Lista estática para guardar el historial de pedidos (cada pedido con resumen simple)
      ...
      body: Column(
        children: [
          ...
          if (orderHistory.isNotEmpty) ...[
            ...
            SizedBox(
              height: 150, // altura fija para el historial para evitar error de renderizado
              child: ListView.builder(
  ...
  void _showOrderConfirmation() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            '¿Quieres confirmar tu pedido? Después de confirmar no podrás hacer cambios.'),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () {
              ...
              orderHistory.add({
                ...
                'total': CartService.totalAmount + 5.00, // incluye delivery
                'date': formattedDate,
              });
